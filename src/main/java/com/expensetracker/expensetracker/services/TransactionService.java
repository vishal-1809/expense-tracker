...
public class TransactionService {
    ...
    public Map<String, Double> getTotalExpenses() {
        ...
        // Calculate the grand total expenses
        double grandTotalExpenses = transactionRepository.sumExpensesBetweenDates(LocalDate.parse("2001-09-18"), currentDate);
        totalExpenses.put("grandtotal", grandTotalExpenses);
    ...
    public Map<String, Double> getTotalIncomes() {
        ...
        double grandTotalIncome = transactionRepository.sumIncomesBetweenDates(LocalDate.parse("2001-09-18"), currentDate);
        totalIncomes.put("grandtotal", grandTotalIncome);
    ...
    public Map<String, Double> getTotalTransactions() {
        ...
        double grandTotalTransaction = transactionRepository.countTransactionsBetweenDates(LocalDate.parse("2001-09-18"), currentDate);
        totalIncomes.put("grandtotal", grandTotalTransaction);
    ...
    // Year-wise monthly income
    public Map<String, Double> getTotalIncomeByMonth_Year(String months, int currentYear) {
    	Map<String, Double> totalIncomesByMonth = new HashMap<>();
        ...
        for (int month = 1; month <= 12; month++) {
            ...
            // Check for null value to avoid NullPointerException
            totalIncomesByMonth.put(yearMonth.getMonth().name(), totalIncome != null ? totalIncome : 0.0);
            System.out.println(totalIncomesByMonth);
        }

        return totalIncomesByMonth;
    }
    
    // Year-wise monthly expense
    public Map<String, Double> getTotalExpensesByMonth_Year(int currentYear) {
        Map<String, Double> totalExpensesByMonth = new HashMap<>();
    ...
    public Map<String, Integer> getTotalTransactionsByMonth_Year(int currentYear) {
        Map<String, Integer> totalTransactionsByMonth = new HashMap<>();
